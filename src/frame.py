...
class Frame(object):
    ...
    def __init__(self, app):
        ...
        #score labels
        self.p1_surf = pygl2d.font.RenderText(self.app.screen_size, positions[1], (0, 255, 0), self.app.f)
        ...
        self.p2_surf = pygl2d.font.RenderText(self.app.screen_size, positions[2], (0, 255, 0), self.app.f)
        ...
        self.p3_surf = pygl2d.font.RenderText(self.app.screen_size, positions[3], (0, 255, 0), self.app.f)
        ...
        self.p4_surf = pygl2d.font.RenderText(self.app.screen_size, positions[4], (0, 255, 0), self.app.f)
        ...
        self.p5_surf = pygl2d.font.RenderText(self.app.screen_size, positions[5], (0, 255, 0), self.app.f)
        ...
        self.p6_surf = pygl2d.font.RenderText(self.app.screen_size, positions[6], (0, 255, 0), self.app.f)
        ...
        self.p7_surf = pygl2d.font.RenderText(self.app.screen_size, positions[7], (0, 255, 0), self.app.f)
        ...
        self.p8_surf = pygl2d.font.RenderText(self.app.screen_size, positions[8], (0, 255, 0), self.app.f)
    ...
    def draw(self):
        ...
        pygl2d.draw.rect(self.app.screen_size, self.app.world, (0, 255, 0), self.app.linewidth)
        
        if not self.app.config['Score']['new_scoring_pos']: #draw frame along bottom of gameworld
            pygl2d.draw.rect(self.app.screen_size, (0, 0, 710 * self.app.aspect_ratio, 63 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth) #bottom box to hold scores
            pygl2d.draw.rect(self.app.screen_size, (0, 32 * self.app.aspect_ratio), (709 * self.app.aspect_ratio, 32 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth) #divides bottom box horizontally into two rows
            #the following seven lines divides the bottom box vertically into 8 columns
            pygl2d.draw.rect(self.app.screen_size, (89 * self.app.aspect_ratio, 0), (89 * self.app.aspect_ratio, 62 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
            pygl2d.draw.rect(self.app.screen_size, (178 * self.app.aspect_ratio, 0), (178 * self.app.aspect_ratio, 62 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
            pygl2d.draw.rect(self.app.screen_size, (267 * self.app.aspect_ratio, 0), (267 * self.app.aspect_ratio, 62 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
            pygl2d.draw.rect(self.app.screen_size, (356 * self.app.aspect_ratio, 0), (356 * self.app.aspect_ratio, 62 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
            pygl2d.draw.rect(self.app.screen_size, (445 * self.app.aspect_ratio, 0), (445 * self.app.aspect_ratio, 62 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
            pygl2d.draw.rect(self.app.screen_size, (534 * self.app.aspect_ratio, 0), (534 * self.app.aspect_ratio, 62 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
            pygl2d.draw.rect(self.app.screen_size, (623 * self.app.aspect_ratio, 0), (623 * self.app.aspect_ratio, 62 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
        else: #draw frame in "eye-tracker-friendly" format
            half_width = self.app.SCREEN_WIDTH / 2
            if self.app.config['General']['next_gen']:
                pygl2d.draw.rect(self.app.screen_size, (half_width - 523 * self.app.aspect_ratio, 70 * self.app.aspect_ratio, 130 * self.app.aspect_ratio, 683 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
                pygl2d.draw.rect(self.app.screen_size, (half_width + 394 * self.app.aspect_ratio, 70 * self.app.aspect_ratio, 130 * self.app.aspect_ratio, 683 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
                pygl2d.draw.rect(self.app.screen_size, (half_width - 383 * self.app.aspect_ratio, 5 * self.app.aspect_ratio, 767 * self.app.aspect_ratio, 57 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
            else:
                pygl2d.draw.rect(self.app.screen_size, (half_width - 495 * self.app.aspect_ratio, 70 * self.app.aspect_ratio, 130 * self.app.aspect_ratio, 626 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
                pygl2d.draw.rect(self.app.screen_size, (half_width + 366 * self.app.aspect_ratio, 70 * self.app.aspect_ratio, 130 * self.app.aspect_ratio, 626 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
                pygl2d.draw.rect(self.app.screen_size, (half_width - 355 * self.app.aspect_ratio, 5 * self.app.aspect_ratio, 710 * self.app.aspect_ratio, 57 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
                pygl2d.draw.rect(self.app.screen_size, (half_width - 355 * self.app.aspect_ratio, 705 * self.app.aspect_ratio, 710 * self.app.aspect_ratio, 57 * self.app.aspect_ratio), (0, 255, 0), self.app.linewidth)
        #score labels
