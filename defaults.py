...
def get_config():
    ...
    cfg.add_setting( 'Display', 'display_mode', 'Fullscreen', alias = 'Display Mode', options = ['Fullscreen', 'Current', 'Windowed', 'Fake Fullscreen'], type = config.constants.CT_COMBO, about = 'Run at full screen? Set to f to run in a window' )
    ...
    cfg.add_setting( 'Logging', 'logDriver', 'Default', alias = 'Log Driver', type = config.constants.CT_COMBO, options = logDrivers )
