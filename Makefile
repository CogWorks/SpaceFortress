...
sf-macosx:
	...
	mv build/exe.macosx-10.6-*-2.6/PSF5 dist/macosx/SpaceFortress.app/Contents/MacOS/SpaceFortress
	mv build/exe.macosx-10.6-*-2.6/PSF5.zip dist/macosx/SpaceFortress.app/Contents/MacOS/SpaceFortress.zip
	mv build/exe.macosx-10.6-*-2.6/*.dylib dist/macosx/SpaceFortress.app/Contents/MacOS/
	mv build/exe.macosx-10.6-*-2.6/*.so dist/macosx/SpaceFortress.app/Contents/MacOS/
	mv build/exe.macosx-10.6-*-2.6/*.zip dist/macosx/SpaceFortress.app/Contents/MacOS/
	...
	mv build/exe.macosx-10.6-*-2.6/* dist/macosx/SpaceFortress.app/Contents/MacOS/
	cd dist/macosx/SpaceFortress.app/Contents/MacOS; \
...
ce-macosx:
	...
	mv build/exe.macosx-10.6-*-2.6/configEditor dist/macosx/configEditor.app/Contents/MacOS/
	mv build/exe.macosx-10.6-*-2.6/*.dylib dist/macosx/configEditor.app/Contents/MacOS/
	mv build/exe.macosx-10.6-*-2.6/PySide* dist/macosx/configEditor.app/Contents/MacOS/
	mv build/exe.macosx-10.6-*-2.6/*.zip dist/macosx/configEditor.app/Contents/MacOS/
	morelibs=`ls build/exe.macosx-10.6-*-2.6`
	...
	mv build/exe.macosx-10.6-*-2.6/* dist/macosx/configEditor.app/Contents/MacOS/
	cd dist/macosx/configEditor.app/Contents/MacOS; \
	for f in $$morelibs; do \
		libs=`otool -XL $$f | grep "/opt/local/lib" | cut -f 2 | cut -f 1 -d " "`; \
 		if [[ -n $$libs ]]; then \
